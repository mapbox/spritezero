 ...
 * @param  {Object[]}    [options.mode] Defaults to alpha perserving 'hextree'. But if you don't need alpha, `octree` might be faster
 * @param  {Object[]}    [options.compression] Defaults to -1 which means node-mapnik will select the image encodings default
 * @param  {Function}    callback  Accepts two arguments, `err` and `image` data
 */
